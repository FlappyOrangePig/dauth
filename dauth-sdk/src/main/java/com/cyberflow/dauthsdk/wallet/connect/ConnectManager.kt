...
//
//    companion object {
//        val instance by lazy { ConnectManager() }
//    }
//
...
//    }
//
//    private fun initSdkInner(context: Context) {
...
//        val (pair, launch) = if (pairs.isEmpty()) {
//            DAuthLogger.d("create", TAG)
//            val created = CoreClient.Pairing.create { error ->
//                DAuthLogger.e(" ${error.throwable.stackTraceToString()}", TAG)
//            } ?: return false
//            created to true
//        } else {
...
//            DAuthLogger.d("connect success, launch=$launch", TAG)
//            if (launch) {
...
//            }
//        }, onError = {
//            DAuthLogger.d("connect error", TAG)
//        })
//        return true
//    }
//
