...
import com.infras.dauth.databinding.DialogFragmentVerifyProcessingBinding
...
class VerifyProcessingDialogFragment : BottomDialogFragment() {

    companion object {
        const val TAG = "VerifyProcessingDialogFragment"
        private const val EXTRA_USER_ID = "EXTRA_USER_ID"
        private const val EXTRA_IS_BOUND = "EXTRA_IS_BOUND"

        fun newInstance(userId: String, isBound: Boolean): VerifyProcessingDialogFragment {
            return VerifyProcessingDialogFragment().also {
    ...
    private var _binding: DialogFragmentVerifyProcessingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogFragmentVerifyProcessingBinding.inflate(inflater, container, false)
